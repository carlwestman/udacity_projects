...
""" 
This file contains all data that the webpage presents.
This file should be runned to dynamically render the 
website from the data structure specified below and the 
rendering functions specified in fresh_tomatoes.py
""" 
